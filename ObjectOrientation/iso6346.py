"""
Generate shipping container code as per ISO 6346 international standard
"""
...
def create(owner_code, serial, category='U'):
    ...
    Returns:
        An ISO 6346 container code having a check digit.
...
def check_digit(raw_code):
    ...
    Args:
        raw_code (str): An ISO 6346 code, not having check digit
